...
<head>
  ...
  <link href="{{ asset('/templates/admin/img/brand/favicon.ico')}}" rel="icon" type="image/png">
  <!-- Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet">
  <!-- Icons -->
  <link href="{{ asset('/templates/admin/js/plugins/nucleo/css/nucleo.css')}}" rel="stylesheet" />
  <link href="{{ asset('/templates/admin/js/plugins/@fortawesome/fontawesome-free/css/all.min.css')}}" rel="stylesheet" />
  <!-- CSS Files -->
  <link href="{{ asset('/templates/admin/css/argon-dashboard.css?v=1.1.2')}}" rel="stylesheet" />
  <link href="{{ asset('/templates/admin/css/customs.css')}}" rel="stylesheet" />
  <link href="{{ asset('/templates/admin/css/fileupload.css')}}" rel="stylesheet" />
  {{-- ChartScript --}}
